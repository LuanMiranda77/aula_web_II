...
namespace App_aula_1.Areas.Identity.Pages.Account
{
    public class RegisterModelNutricionista : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "As senhas não pode ser diferentes")]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            ViewData["IdPlano"] = new SelectList(_context.TbPlano.Where(p => p.IdPlano == 3 || p.IdPlano == 4), "IdPlano", "Nome");
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //Atribuindo a role ao usuario
                        await _userManager.AddToRoleAsync(user, "Nutricionista");

                        Input.TbProfissional.IdContratoNavigation.DataInicio = DateTime.UtcNow;
                        Input.TbProfissional.IdContratoNavigation.DataFim = Input.TbProfissional.IdContratoNavigation.DataInicio.Value.AddMonths(2);
            ...
            ViewData["IdPlano"] = new SelectList(_context.TbPlano, "IdPlano", "Nome", Input.TbProfissional.IdContratoNavigation.IdPlanoNavigation);
